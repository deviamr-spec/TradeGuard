...
class TradingBotGUI(QMainWindow):
    ...
    def __init__(self, mt5_client: MT5Client, trade_engine: TradeEngine):
        ...
        # Initialize risk_manager from trade_engine if it exists
        self.risk_manager = getattr(self.trade_engine, 'risk_manager', None)
    ...
    def create_left_panel(self) -> QWidget:
        ...
        try:
            ...
            # Risk Monitor
            # FIXED: Initialize RiskMonitorWidget with risk_manager
            self.widgets['risk_monitor'] = RiskMonitorWidget(self.risk_manager)
    ...
    def create_center_panel(self) -> QWidget:
        ...
        try:
            ...
            # Market Data Tab
            # FIXED: Pass symbols from trade_engine
            symbols = self.trade_engine.symbols if hasattr(self.trade_engine, 'symbols') else []
    ...
    def update_account_info(self):
        ...
        try:
            if 'account' in self.widgets and hasattr(self.widgets['account'], 'update_data'):
                self.widgets['account'].update_data()
        except Exception as e:
    ...
    def update_market_data(self):
        ...
        try:
            if 'market_data' in self.widgets and hasattr(self.widgets['market_data'], 'update_data'):
                self.widgets['market_data'].update_data()
        except Exception as e:
    ...
    def update_positions_data(self):
        ...
        try:
            if 'positions' in self.widgets and hasattr(self.widgets['positions'], 'update_data'):
                self.widgets['positions'].update_data()
        except Exception as e:
            self.logger.error(f"❌ Error updating positions data: {str(e)}")

    def update_performance_data(self):
        """Update performance monitor widget."""
        try:
            if 'performance_monitor' in self.widgets and hasattr(self.widgets['performance_monitor'], 'update_data'):
                self.widgets['performance_monitor'].update_data()
        except Exception as e:
